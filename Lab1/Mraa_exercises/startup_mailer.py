...
def connect_type(word_list):
    """ This function takes a list of words, then, depeding which key word, retu
...
buzz_pin_number=6
buzz = mraa.Gpio(buzz_pin_number)       # Configuring the buzzer as GPIO interfaces
buzz.dir(mraa.DIR_OUT)                  # Configuring the buzzer as output
buzz.write(1)
time.sleep(0.2)
buzz.write(0)
...
# Account Information
to = ['jo2522@columbia.edu', 'al3475@columbia.edu', 'jh3853@columbia.edu'] # Email to send to.
gmail_user = 'junyanghu3853@gmail.com' # Email to send from. (MUST BE GMAIL)
gmail_password = 'Hjy941219' # Gmail password.
